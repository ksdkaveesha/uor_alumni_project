                ...
                if(membership === 'Full') {
                    ...
                    modalContent.html(`
                        ...
                        <ul>
                          <li>
                              Any individual who was a registered student at the Faculty of Science for a particular 
degree program for a minimum of one academic year.
                          </li><br>
                          <li>
                              Any individual (local/ foreign), who was a student at the Faculty of Science registered for 
a program other than a degree-bound study program, such as traineeship, internship, and 
research affiliation (etc). 
                          </li><br>
                          <li>
                              Any academic/ academic support staff member affiliated with the Faculty of Science, 
