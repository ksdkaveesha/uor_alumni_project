                    ...
                    <form action="<?=url('/add_admin_by_admin')?>" method="post">
                      @csrf
                        <div class="form-group">
                          ...
                          <div class="form-group">
                              <label for="address"><h4><b>Admin Personal Details</b></h4></label>
                          </div>
                          <div class="form-group">
                      ...
                      <div id="login_details">
                          <div class="form-group">
                              <label for="address"><h4><b>Login Details</b></h4></label>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="confirmPassword" id="a_confirmPassword" onfocus="showaConfirmPassword()" onblur="maskaConfirmPassword()" required>
                          </div>
                      </div>
            ...
            <div class="col-lg-6 mt-5 mt-lg-0 d-flex align-items-stretch">
                <div id="alumni_personal_details">
                    ...
                    <div id="login_details">
                        ...
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="text" class="form-control" name="email" id="m_email" value="{{old('email')}}" required>
                            @error('email')
                                    <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <script>
                            ...
                            function maskmPassword() {
                                const passwordInput = document.getElementById('m_password');
                                passwordInput.type = 'password';
                            }

                            function showmConfirmPassword() {
                                const confirmPasswordInput = document.getElementById('m_confirmPassword');
                                confirmPasswordInput.type = 'text';
                            }

                            function maskmConfirmPassword() {
                                const confirmPasswordInput = document.getElementById('m_confirmPassword');
                                confirmPasswordInput.type = 'password';
                            }
                        </script>
