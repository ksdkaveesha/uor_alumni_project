              ...
              <form action="<?=url('')?>" method="post">
                ...
                <div id="alumni_personal_details">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="sc_number" id="sc_number" >
                    </div>
                    <div class="row">
                ...
                <div id="login_details">
                    ...
                    <script>
                        $(document).ready(function(){
                            $("#alumni_personal_details").hide();
                            $("#admin_personal_details").hide();
                            $("#login_details").hide();
                            // When the value of the first select changes
                            $("#user_type").change(function(){
                                ...
                                // If "Have a Job" is selected, show the second select; otherwise, hide it
                                if($(this).val() === "admin"){
                                    $("#admin_personal_details").show();
                                    $("#login_details").show();
                                    $("#alumni_personal_details").hide();
                                } else if($(this).val() === "alumni"){
                                    $("#alumni_personal_details").show();
                                    $("#login_details").show();
                                    $("#admin_personal_details").hide();
                                }
                            });
