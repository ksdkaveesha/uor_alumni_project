    ...
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="#contact" class="nav-link scrollto"><i class="bx bx-envelope"></i> <span>Edit Members</span></a></li>
          <li><a href="#" class="nav-link scrollto"><i class="bx bx-book-add"></i> <span>Add Notices</span></a></li>
